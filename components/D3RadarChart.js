...
// Object constructor
var D3RadarChart = function() {
};

D3RadarChart.prototype = new D3BaseChart;
D3RadarChart.prototype.constructor = D3RadarChart;
...
D3RadarChart.prototype.create = function(el, props, data) {
  this.props = props;
...
D3RadarChart.prototype.update = function(el, data) {
  var svg = d3.select(el).select('svg.radar-chart'); 
...
D3RadarChart.prototype.destroy = function(el) {
  d3.select(el).select('svg.radar-chart').remove();
};

D3RadarChart.prototype._center = function() {
...
D3RadarChart.prototype._maxRadius = function() {
  return Math.min(this.props.width, this.props.height) / 2;
};

D3RadarChart.prototype._polarScales = function(domains) {
...
D3RadarChart.prototype._polarToRect = function(r, theta, origin) {
...
// Draw axes
D3RadarChart.prototype._drawRadialAxis = function(svg, data) {
...
D3RadarChart.prototype._drawLines = function(svg, data) {
  var scales = this._polarScales(data.domains);
